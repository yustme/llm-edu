...
import { Step2ApprovalPatterns } from "./steps/Step2ApprovalPatterns";
import { Step3Feedback } from "./steps/Step3Feedback";
import { Step4ApprovalDemo } from "./steps/Step4ApprovalDemo";
import { Step5ConfidenceRouting } from "./steps/Step5ConfidenceRouting";
...
function StepContent({ step }: { step: number }) {
  switch (step) {
    case 1:
      return <Step1Intro />;
    case 2:
      return <Step2ApprovalPatterns />;
    case 3:
      return <Step3Feedback />;
    case 4:
      return <Step4ApprovalDemo />;
    case 5:
      return <Step5ConfidenceRouting />;
    case 6:
      return <Step6Summary />;
    default:
      return null;
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="flex-1 overflow-auto p-8">
        <SlideContainer
          animationKey={`module22-step-${currentStep}`}
          direction="right"
        >
