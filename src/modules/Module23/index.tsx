...
import { Step2LoopDiagram } from "./steps/Step2LoopDiagram";
import { Step3SqlDemo } from "./steps/Step3SqlDemo";
import { Step4ErrorClassification } from "./steps/Step4ErrorClassification";
import { Step5BroaderPatterns } from "./steps/Step5BroaderPatterns";
...
function StepContent({ step }: { step: number }) {
  switch (step) {
    case 1:
      return <Step1Intro />;
    case 2:
      return <Step2LoopDiagram />;
    case 3:
      return <Step3SqlDemo />;
    case 4:
      return <Step4ErrorClassification />;
    case 5:
      return <Step5BroaderPatterns />;
    case 6:
      return <Step6Summary />;
    default:
      return null;
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="flex-1 overflow-auto p-8">
        <SlideContainer
          animationKey={`module23-step-${currentStep}`}
          direction="right"
        >
