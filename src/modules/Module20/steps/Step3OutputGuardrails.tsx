...
export function Step3OutputGuardrails() {
  ...
  useEffect(() => {
    registerQueries(OUTPUT_EXAMPLES.length);
    return () => registerQueries(0);
  }, [registerQueries]);

  const selected = OUTPUT_EXAMPLES[queryIndex] ?? OUTPUT_EXAMPLES[0];
        ...
        >
          ...
          <div className="space-y-2 pt-2">
            ...
            <div className="flex flex-col gap-2">
              {OUTPUT_EXAMPLES.map((example, idx) => (
                <Button
                  key={example.id}
